...
def insertar_resultado(palabra, url, descripcion, fecha, conn):
    try:
        cursor = conn.cursor()
        cursor.execute("INSERT INTO tabla_de_resultados (palabra, url, descripcion, fecha) VALUES (%s, %s, %s, %s)",
...
def buscar_palabra(palabra, url, conn):
    ...
    if response.status_code == 200:
        ...
        if palabra in descripcion:
            ...
            print("palab no encontrada en la descripción de la URL:", url)
            ...
            if response.status_code == 200:
                ...
                for cada_enlace in enlaces:
                    ...
                    if enlace_url.startswith('http') and enlace_url not in enlaces_explorados:
                        ...
                        buscar_palabra("Puno", enlace_url, conn)
